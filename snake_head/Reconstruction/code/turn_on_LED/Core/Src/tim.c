...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOD, M1PWMA_Pin|M1PWMB_Pin|PWM2_Pin);
